...
**Answer** The column names are the same as those on the actual website. "Date" and "News Release/News Item". Also the date column is listed as a character column when it is clearly a date. That means we need to clean up the data ourselves. 
...
**Answer** Maybe they could be broken down by category and or location. 
...
**Answer** 122 because of the "{xml_nodeset (122)}" at the top.
...
**Answer** A few social media links but the majority of the output is a list of different press releases. In descending chronological order. 
...
**Answer** Makes a data frame of the text of the title of the press releases. 
