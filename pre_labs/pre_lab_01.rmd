...
**Answer** Line 128 is use the umd_course data frame, Line 129 is saying group by each term, Line 130 is saying to summarize the data frame into one value , Line 131 says to create a column named "count classes" and to add up all the classes within a given term.  
