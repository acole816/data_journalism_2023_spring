...
**Answer** This is because the computer is only looking for words that begin with "W" or "w", and counting how many times that sting is dete3cted. However, similar to last weeks lab, there are some grantee's that are spelled slightly differently but are clearly the same organization. For example, "WASHINGTON COUNTY COMMUNITY ACTION COUNCIL" and "WASHINGTON COUNTY COMMUNITY ACTION COUNCIL INC" are clearly the same thing, but the program does not combine them together, rather counts them as two seperate organizations. 
...
**Answer** "Melwood Horticultural Training Center, Inc." was changed to "Melwood Horticultural Training Center" and "Southern Maryland Tri-County. Community Action Committee (SMTCCAC Inc.)" got changed to "Southern Maryland Tri-County. Community Action Committee, Inc (SMTCCAC Inc)".
...
**Answer** "WASHINGTON ADVENTIST UNIVERSITY" became "Washington Adventist University". Besides this, I can't find any differences in the names between the "Grantee" and "grantee_clean" columns in the first 30 results.
...
**Answer** I see no differnces between the results from this codeblock and the previous in the first 30 rows. 
