...
**Answer** Baltimore City was the jurisdiction with the largest increase in median income. No jurisdiction saw their estimated median income fall between 2010 and 2021. 
...
**Answer** Does household income by county impact the percent of high school graduates enrolled in college? Do the top counties in terms of median income (Howard, Calvert, Mont., etc.) have the highest percentage of high school graduates enrolled in college? What make this hard is that some counties have more schools then other and that college enrollment may not directly trasnlate to greater median income. 
...
**Answer** The median income of in counties that have greater then 60% college enrollment from high school graduates was $40,000 higher then 
...
**Answer** I think it would be good to make a graph of the relationship between median income in a county and the percent of high schooo, graduates enrolled in college. This may not be a new question of the data itself, but what type of chart would look best? A double bar graph? A plot graph? How do we code those different things.
