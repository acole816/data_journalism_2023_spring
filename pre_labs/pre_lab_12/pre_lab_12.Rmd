...
**Answer** A data frame of the dates, title, url and text of all of Ben Cardin's press releases. 
...
**Answer** It kept both "Dog" and "dog" because of the different capitalization but eliminated one of the "cat"s because they are the same capitalization. 
...
**Answer** It is taking all of the words in the 'text' column of the releases data frame and putting htme into individual rows in a new data frame with the column name 'word'.
...
**Answer** The graphic is showing how many times each word shwos up in our new 'word' data frame. It is someone interesting, although I tihnk it would be better to eliminate all of the prepositions like 'the', 'and', 'of' and so on to get more useful data. Also, I don't know what 'd' means... Maybe deriving from D as in Democrat used next to politicans/Cardin's name...?
...
**Answer** This is defintely more interesting then before. We now elimated the meaningless words like 'the' and 'a' and are now looking at words that actually have weight to them and tell us more things about Cardin's releases
...
**Answer** We now have three different data frames like the one from task 9 broekn down by year. 
...
**Task** Run the following code and describe the results.
**Answer** The results show the top 10 words used together in Cardin's releases pre 2022, filtering out all of the stop words. 
...
**Task** Run the following code and describe the results.
**Answer** Same thing as task 12, but nown looking at everything pre 2023 oppose to pre 2022. 
...
**Task** Run the following code and describe the results.
**Answer** Same thing as last 2 task, but now jsut looking at releases from 2023.
...
**Answer** This created a new data frame with a lsit of words and if they are positive or negative in nature. It looks like all the words are right from what I can see, but its all about the context in which they are being used. 'Cancer' fro example is listed as bad, but often times 'cancer' is spoken in the context of 'beating cancer' which is a positive thing. I'm not so sure how helpful this is because all of the sentiments seem very logically sound and anyone could look at these words individualy and assign positive or negative. Is this function looking at the context in which the words are most frequently used?
