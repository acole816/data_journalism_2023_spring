...
```{r}
voters_by_county <- read_csv("tabula-Eligible Active Voters by County - GP22.csv") %>% clean_names()
...
**Answer**  There still isn't proper column names for the data frame. The column names are now showing as "x2", "x3", "x4", etc, which doesn't help us to understand the data we are looking at.
...
**Answer** We still have the "......." after all the county names, which is going to mess up our filtering for specific questions. The codeblock for task 8 fixes this issue.  
