...
**Answer** Data frame showing states, who won the Presidential election in that state in 2016, Trump's voter share percentage in that state, percent of businesses in that state receiving PPE loans and 
```{r}
