...
https://datawrapper.dwcdn.net/oXTge/1/
...
The originally map was very zoomed out and you could barely see MD. Now, the only thing you can see is Md and it is much more clear.
...
The previous map, when hovering over the county, would jsut show the number code for that county, which almsot no readers will know what that means. Now, the map shows the actual county name as well as the percentage of votes Moore recieved in that county.
...
https://datawrapper.dwcdn.net/Nww5v/1/
